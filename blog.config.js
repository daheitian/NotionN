...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '7280c13037e8477e9dd52ec1c733357e',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '小信号',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '小信号', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '办公 设计  思考 灵感', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://apaper.super.site/', // 网站地址
...
// END ************网站字体*****************
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://twikoo.xiaoxinhao.top', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
